...
int main()
{
	...
	//Track track("spline_parts/test_track.sp");
	...
	Model ourModel("../Project_2/Media/bathysphere/bathysphere.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		track.Draw(lightingShader_basic, heightmap_texture);
		...
		glBindVertexArray(cubeVAO); //fixed
